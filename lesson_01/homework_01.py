...
print("Всього дерев посадили у саду:", total_trees)
...
print("Температура надвечір:", evening_temperature, "градуси")
...
print("Сьогодні дітей у театральному гуртку:", total_kids)
...
print("Всі книжки коштують:", total_price, "грн")
# Ready for check
